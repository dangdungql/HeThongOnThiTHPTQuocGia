                        ...
                        <div class="baihoc-header">
                            ...
                            <div class="pad-30">
                                ...
                                <div class="wrap-input100" data-validate = "Valid email is required: ex@abc.xyz">
                                    ...
                                    <input class="input100" type="text" name="tenbaihoc"  placeholder="Nhập tên bài học...">
                                    <span class=""></span>
                                </div>
                            </div>
                        </div>
				...
				<td>
					<div class="form-check-inline">
						<label class="container-btn1 mdl-radio__label">Vận dụng cao
						  <input type="checkbox" checked="checked" class="chb" name="mucdo[]" value="4">
				...
				<td>
					<div class="form-check-inline">
						<label class="container-btn1 mdl-radio__label">Vân dụng
						  <input type="checkbox" checked="checked" class="chb" name="mucdo[]" value="3">
						  <span class="checkmark1"></span>
						</label>
					</div>
					<!-- <p><i>0 bài</i></p> -->
				...
				<td>
					<div class="form-check-inline mdl-radio__label">
						<label class="container-btn1 color-red">Thông hiểu
						  <input type="checkbox" checked="checked" class="chb" name="mucdo[]" value="2">
						  <span class="checkmark1"></span>
						</label>
					</div>
					<!-- <p><i>0 bài</i></p> -->
				...
				<td>
					<div class="form-check-inline mdl-radio__label">
						<label class="container-btn1">Nhận biết
						  <input type="checkbox" checked="checked" class="chb" name="mucdo[]" value="1">
						  <span class="checkmark1"></span>
						</label>
					</div>
					<!-- <p><i>0 bài</i></p> -->
                                    ...
                                    <input type="submit" class="btn-style-general" name="2" value="Tự tạo câu hỏi trắc nghiệm"/>
                                </br>
                                			                                </br>
                                <input type="submit" name="1" class="btn-style-general" value="Thêm mới"> 
                            </div>
