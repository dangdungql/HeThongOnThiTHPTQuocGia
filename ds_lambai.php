        ...
        <div class="show-gird col-12 col-sm-12">
                ...
                <table class="table table-striped tm-full-width-large-table">
                    ...
                    <tbody>
                       ...
                       <?php
                        $query_2 = "SELECT DISTINCT u.hoten,dt.TenDeThi, hsbt.diem , hsbt.gionapbai FROM hs_baithi hsbt, tbluser u,dethi dt WHERE hsbt.id_user = u.taikhoan and hsbt.id_baithi=dt.Made and dt.Made=".$dethi;
