...
<?php
		                $query = "SELECT * FROM chitietcongthuc WHERE MaChiTiet=1";
	...
	<div class="container pad-60" id="addLesson">
		<div class="row">
			...
			<div class="col-12" style="margin-bottom: 30px;">
				<a href="addListlesson.php?mh=2" type="button" class="lesson-btn-title back-btn-lesson"><i style="font-size: 40px;transform: rotate(180deg);margin-left: -7px;" class="fa fa-sign-out" aria-hidden="true"></i></a>
				<span class="text-title">HH010101 – Este-Lipit: Khái niệm, tên gọi, CTTQ của este, tính chất vật lý</span>
			</div>
		</div>
		<div class="row">
		...
		<div class="row pad-60">
			<div class="col-12 col-sm-8 do-homework">
				...
				<br>
				<p class="thang-cham-diem"> Kết quả Giỏi, Thường, hay Yếu phụ thuộc vào mức độ hoàn thành bài tập và được tô màu ở phần danh sách bài giảng. </p>
				<br>
				<div class="row text-center">
					<div class="col-12 col-sm-4 lesson-mobile-bottom">
						<div class="cirle cirle-kha"><span></span></div>
						<button onclick="window.location.href = 'miniquiz.php?congthuc=19&cauhoi=0&dung=0&sai=0';" class="btn-background-green btn-lesson">Câu hỏi cơ bản</button>
					</div>
					<div class="col-12 col-sm-4 lesson-mobile-bottom">
						<div class="cirle cirle-yeu"><span></span></div>
						<button onclick="window.location.href = 'miniquiz.php?congthuc=19&cauhoi=0&dung=0&sai=0';" class="btn-background-green btn-lesson">Câu hỏi nâng cao</button>
					</div>
					<div class="col-12 col-sm-4 text-left lesson-mobile-bottom">
						<h5 style="color:#00a99d;">Màu trạng thái</h5>
						<div><i class="fa fa-square fa-square-yeu"></i><span>Nhận biết</span></div>
						<div><i class="fa fa-square fa-square-tb"></i><span>Thông hiểu</span></div>
						<div><i class="fa fa-square fa-square-kha"></i><span>Vận dụng</span></div>
						<div><i class="fa fa-square fa-square-gioi"></i><span>Vận dụng cao</span></div>
    ...
    function listReplies(commentId, data, list) {
        for (var i = 0; (i < data.length); i++)
        {
            if (commentId == data[i].parent_id)
            {
                ...
                "<div class='col-2-edit'><img class='avatar-comment' src='"+data[i]['hinhanh']+"'></div>"+
                "<div class='col-10-edit' style = 'align-self: center;'>"+
                "<span class='user-name'>"+data[i]['hoten']+ " : " + data[i]['comment'] + "</span>"+
