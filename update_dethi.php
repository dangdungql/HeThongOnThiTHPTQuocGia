...
$query_2 = "SELECT * FROM dethi WHERE Made=".$madethi;
                ...
                <div class="wrap-contact100 fade-in">
                    ...
                    <form class="contact100-form validate-form" name="frmbaiviet" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="baihoc-content">
                            <div class="baihoc-header-title"><span class="contact100-form-title"><i class="fa fa-upload" aria-hidden="true"></i>Cập nhật bài thi</span></div>
                            <div class="pad-30">
                                <div id='path-group'>
                                    <?php
                                        $query = "SELECT * FROM dethi WHERE Made=".$madethi;
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <iframe id="iView" src="tinymce/update_dialog_dethi.php?ct=<?php echo $madethi; ?>&field_id=path" style="border: none;width: 100%; height: 500px;"></iframe>
