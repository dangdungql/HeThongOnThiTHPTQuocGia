...
$config = include 'config/config_dethi.php';
...
<html>
	...
	<script src="js/include_1.js?v=<?php echo $version; ?>"></script>
</head>
<body>
...
<!-- header div end -->
	...
	<div class="row-fluid">
	<?php
	$link="dialog_dethi.php?".$get_params;
	?>
	<ul class="breadcrumb">
	...
	<?php } ?>
	<li class="pull-right"><a id="refresh" class="btn-small" href="dialog_dethi.php?<?php echo $get_params.$subdir."&".uniqid() ?>"><i class="icon-refresh"></i></a></li>
	...
	<div class="span12">
		...
		foreach ($files as $file_array) {
			...
			?>
				...
				<?php } ?>
				<a class="folder-link" href="dialog_dethi.php?<?php echo $get_params.rawurlencode($src)."&".($callback?'callback='.$callback."&":'').uniqid() ?>">
			...
			<?php }else{ ?>
					...
					<div class="box">
					<h4 class="<?php if($config['ellipsis_title_after_first_row']){ echo "ellipsis"; } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="dialog_dethi.php?<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>"><?php echo $file;?></a></h4>
					</div>
